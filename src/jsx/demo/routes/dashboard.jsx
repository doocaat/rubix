...
class MainChart extends React.Component {
  componentDidMount() {
    var chart = new Rubix('#main-chart', {
      width: '80%',
      height: 500,
      title: 'Blood Pressure Beat or Time',
      titleColor: '#2E9999',
      subtitle: 'Period: 2013 and 2015',
      ...
      <Grid>
        <Row>
          <Col xs={12} className='text-center'>
            ...
            <div>
              <h4>New Users</h4>
              <h2 className='fg-green visible-xs visible-md visible-lg'>28</h2>
              <h4 className='fg-green visible-sm'>28</h4>
            </div>
            <hr className='border-green'/>
            <div>
              <h4>Dropped Users</h4>
              <h2 className='fg-green visible-xs visible-md visible-lg'>3</h2>
              <h4 className='fg-green visible-sm'>3</h4>
            </div>      
          </Col>
        </Row>
      </Grid>
                  ...
                  <Table striped>
                    ...
                    <tbody>
                      ...
                      <tr className='warning'>
                        <td><div style={{width: 25, height: 25, borderRadius: '5px', backgroundColor: '#FCDB56'}}></div></td>
                        <td>Curie, Marie</td>
                      ...
                      <tr className='danger'>
                        <td><div style={{width: 25, height: 25, borderRadius: '5px', backgroundColor: '#E34646'}}></div></td>
                                    ...
                                    <div> 
                                      <table style={{width: '80%'}}>
                                        ...
                                        <tbody>
                                          ...
                                          <tr><td>Hypertension</td><td style={{textAlign: 'right'}}> 10%</td></tr>
                                          <tr><td>Pre-Diabetes</td><td style={{textAlign: 'right'}}> 20% </td></tr>
                                          <tr><td>Diabetes</td><td style={{textAlign: 'right'}}> 10% </td></tr>
                                          <tr><td>Overweight</td><td style={{textAlign: 'right'}}> 10% </td></tr>
                                          <tr><td>Obese</td><td style={{textAlign: 'right'}}> 10%</td></tr>
                                        </tbody>
                                      </table>
                                    </div>
                                  </Col>
                ...
                <Panel>
                  <PanelBody>
                    <Grid>
                      <Row>
                        <Col xs={12}>
                          <h4 style={{marginTop: 0}}>TOP CAMPAIGNS</h4>
                          <Datatable />
                        </Col>
                      </Row>
                    </Grid>
